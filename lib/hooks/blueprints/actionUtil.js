...
var actionUtil = {
  ...
  populateRequest: function(query, req) {
    var DEFAULT_POPULATE_LIMIT = req._sails.config.blueprints.defaultLimit || (req._sails.config.blueprints.defaultLimit == 0 ? 0 : 30);
  ...
  */
  populateQuery: function(query, associations, sails) {
    var DEFAULT_POPULATE_LIMIT = (sails && sails.config.blueprints.defaultLimit) || (sails.config.blueprints.defaultLimit == 0 ? 0 : 30);
  ...
  parseLimit: function (req) {
    var DEFAULT_LIMIT = req._sails.config.blueprints.defaultLimit || (req._sails.config.blueprints.defaultLimit == 0 ? 0 : 30);
